...
while True:
	...
	if ch == 1 :
		os.system("python3 TELNET-CLIENT.py")
	elif ch == 2 :
		os.system("python3 TELNET-SERVER.py")
	elif ch == 3 :
		os.system("service xinetd status")
		input("Enter to continue......")
	elif ch == 4 :
		os.system("python3 ALLOW-ADD.py")
	elif ch == 5 :
		os.system("python3 ALLOW-REMOVE.py")
	elif ch == 6 :
		os.system("python3 RESTRICT-ADD.py")
	elif ch == 7 :
