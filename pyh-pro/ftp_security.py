...
while x==5	:
		...
		if choice ==1:
			os.system("python3 ftp_display_allow.py");
			os.system("clear");
		elif choice == 2 :
			os.system("python3 ftp_display_deny.py")
			os.system("clear")
		elif choice == 3:
			os.system("python3 ftp_add_allow.py")
			os.system("clear")
		elif choice == 4:
			os.system("python3 ftp_delete_allow.py")
			os.system("clear")
		elif choice == 5:
			os.system("python3 ftp_add_deny.py")
			os.system("clear")
		elif choice == 6:
			os.system("python3 ftp_delete_deny.py")
			os.system("clear")
		elif choice == 7:
			sys.exit();
		else:
